...
\hypersetup{unicode=true,
            pdftitle={607 Project 3},
            pdfauthor={Katherine Evers},
            pdfborder={0 0 0},
            breaklinks=true}
...
\CommentTok{# library(wordcloud)}
\CommentTok{# library(tidytext)}
\CommentTok{# library(xtable)}
\CommentTok{# library(readr)}
\CommentTok{# library(tidytext)}
\CommentTok{# library(knitr)}
\CommentTok{# library(phrasemachine)}
\CommentTok{# library(quanteda)}
\CommentTok{# library(tidyr)}
\end{Highlighting}
\end{Shaded}

\subsection{New final web scraping
code}\label{new-final-web-scraping-code}
